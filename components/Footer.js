	...
	return (
		<footer className="px-4 divide-y bg-[#1a1a1a] text-gray-100">
			<div className="container flex flex-col justify-between py-4 mx-auto space-y-8 lg:flex-row lg:space-y-0">
				...
				<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 ">
					<div className="space-y-3">
						<h3 className="tracki uppercase text-[#7765f3] ">
							Product
						</h3>
					...
					<div className="space-y-3">
						...
						<ul className="space-y-1 text-gray-50">
							{["Public API", "Documentation", "Guides"].map(
								(menu, i) => (
									<li key={i + 1}>
										<a rel="noopener noreferrer" href="#">
											{menu}
					...
					<div className="space-y-3">
						<div className="uppercase text-[#7765f3]">
							Social Media
						</div>
						<div className="flex justify-start space-x3 text-gray-50">
							<a
								rel="noopener noreferrer"
								href="#"
								title="Facebook"
			...
			<div className="py-6 text-sm text-center border-[#7765f3] border-t-[3px] text-gray-400 ">
				&#169; 2024 TechInnovations Limited. All rights reserved
			</div>
		</footer>
	);
};
